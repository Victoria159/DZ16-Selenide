...
public class Expectations {
    ...
    public void strangerThingsSearchPobeda() {
        ...
        Assert.assertEquals(driver.findElement(By.xpath("//*[@id=\"__next\"]/div[2]/main/div/div/div[1]/div/div[1]/button[9]/div[2]/div/div")).getText(), "Полетели в Калининград!");

        //Кликнуть на переключатель языка
        driver.findElement(By.xpath("//header//div[1]/div[2]/button[1]")).click();
        //выбрать английский язык
        Assert.assertEquals(driver.findElement(By.xpath("/html/body/div[4]/div/div/button[2]/div")).getText(), "English");
        wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath("/html/body/div[4]/div/div/button[2]/div")))).click();
